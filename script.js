...
const keys = new Set();
const langKey = "play-zone-language";
...
let currentLang = localStorage.getItem(langKey) || "mn";
...
const translations = {
  mn: {
    scoreLabel: "Оноо",
    livesLabel: "Амь",
    menuSubtitle: "Тоглоомоо сонгоод leaderboard дээр record-оо гарга.",
    catcherTileDesc: "Од барьж, солироос булт.",
    guessTileDesc: "Цөөн оролдлогоор тоог ол.",
    catcherStartText: "Унаж буй оддыг цуглуулаад солируудаас бултаарай.",
    bestScoreLabel: "Дээд оноо",
    noScores: "Одоогоор оноо алга",
    guessButton: "Taah",
    newNumber: "New number",
    attemptsLabel: "Оролдлого",
    guessHistoryTitle: "Таасан түүх",
    noGuesses: "Одоогоор тоо оруулаагүй",
    nameTitle: "Тоглох нэрээ оруул",
    nameLabel: "Нэр",
    nextLevel: "Дараагийн level",
    nameHelp: "Энэ нэрээр leaderboard дээр оноо хадгалагдана.",
    nameFirst: "Эхлээд нэрээ нэг удаа оруулна. Дараа нь автоматаар хадгалагдана.",
    guessIntro:
      "Bi 1-10000 hoorond neg too songoson. Chi oorigoo suga bish gedgee batlaarai.",
    guessInvalid: "1-10000 hoorond too bich bro.",
    guessHigh: "Deeshee bro, ter too chini gazar door yavj bn.",
    guessLow: "Baga too oruul, nar ruu nisgechlee.",
    guessWinPrefix: "Taalaa!",
    guessWinSuffix: "oroldlogoor taalaa.",
    tooHighHistory: "deeshee",
    tooLowHistory: "bagasa",
    correctHistory: "taalaa",
    gameOver: "Тоглоом дууслаа. Чиний оноо:",
    catcherStart: "Унаж буй оддыг цуглуулаад солируудаас бултаарай.",
    guessPlaceholder: "Too oruul",
  },
  en: {
    scoreLabel: "Score",
    livesLabel: "Lives",
    menuSubtitle: "Pick a game and put your record on the leaderboard.",
    catcherTileDesc: "Catch stars and dodge meteors.",
    guessTileDesc: "Find the number in fewer tries.",
    catcherStartText: "Catch falling stars and dodge the meteors.",
    ...
    nameTitle: "Enter your player name",
    nameLabel: "Name",
    nextLevel: "Next level",
    nameHelp: "This name will be used on the leaderboard.",
    nameFirst: "Enter your name once. It will be saved automatically.",
    guessIntro: "I picked a number from 1 to 10000. Prove you are not guessing blindly.",
    guessInvalid: "Enter a number from 1 to 10000.",
    guessHigh: "Go higher. That number is crawling underground.",
    guessLow: "Go lower. You launched that number into space.",
    guessWinPrefix: "Correct!",
    guessWinSuffix: "attempts.",
    tooHighHistory: "higher",
    tooLowHistory: "lower",
    correctHistory: "correct",
    gameOver: "Game over. Your score:",
    catcherStart: "Catch falling stars and dodge the meteors.",
